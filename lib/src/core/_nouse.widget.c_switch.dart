...
// import 'painter.c_switch_thumb.dart';

// /// TODO: Not finished switch
// /// Do not use
...
//   /// {@template flutter.cupertino.CSwitch.dragStartBehavior}
...
// class _CSwitchState extends State<CSwitch> with TickerProviderStateMixin {
...
//   @override
//   void didUpdateWidget(CSwitch oldWidget) {
...
//           : MouseCursor.defer,
//       child: Opacity(
//         opacity: widget.onChanged == null ? _kCSwitchDisabledOpacity : 1.0,
//         child: _CSwitchRenderObjectWidget(
//           value: widget.value,
...
//           state: this,
//           inactiveChild: CCircularProgressIndicator(
//             size: 14,
//             padding: EdgeInsets.zero,
//           ),
//           activeChild: Icon(Icons.check),
//         ),
//       ),
//     );
//   }
...
// // class _CSwitchRenderWidget extends StatelessWidget {
// //   const _CSwitchRenderWidget({
// //     Key? key,
// //     required this.value,
...
// //   final Color thumbColor;
// //   final ValueChanged<bool>? onChanged;
// //   final _CSwitchState state;
// //   final TextDirection textDirection;
// //   @override
// //   Widget build(BuildContext context) {
// //     final double currentValue = state.position.value;
// //     final double currentReactionValue = state._reaction.value;
// //     return Center(
// //       child: Container(
...
// //           Text(currentReactionValue.toString()),
// //         ]),
// //       ),
// //     );
// //   }
...
// class _CSwitchRenderObjectWidget extends SingleChildRenderObjectWidget {
//   _CSwitchRenderObjectWidget(
//       {Key? key,
//       required this.value,
//       required this.activeColor,
//       required this.trackColor,
...
//   @override
//   _RenderCSwitch createRenderObject(BuildContext context) {
//     return _RenderCSwitch(
//       value: value,
...
//   @override
//   void updateRenderObject(BuildContext context, _RenderCSwitch renderObject) {
//     renderObject
//       ..value = value
//       ..activeColor = activeColor
//       ..trackColor = trackColor
...
// const double _kCSwitchDisabledOpacity = 0.5;

// const Duration _kReactionDuration = Duration(milliseconds: 300);
// const Duration _kToggleDuration = Duration(milliseconds: 200);

// class _RenderCSwitch extends RenderConstrainedBox {
//   _RenderCSwitch({
//     required bool value,
...
//     required _CSwitchState state,
//   })  : _value = value,
//         _activeColor = activeColor,
//         _trackColor = trackColor,
//         _thumbPainter = CSwitchThumbPainter.switchThumb(color: thumbColor),
...
//   CSwitchThumbPainter _thumbPainter;
//   set thumbColor(Color value) {
//     if (value == thumbColor) return;
//     _thumbPainter = CSwitchThumbPainter.switchThumb(color: value);
//     markNeedsPaint();
//   }
...
//         CSwitchThumbPainter.extension * currentReactionValue;
//     final double thumbLeft = lerpDouble(
//       trackRect.left + _kTrackInnerStart - CSwitchThumbPainter.radius,
//       trackRect.left +
//           _kTrackInnerEnd -
//           CSwitchThumbPainter.radius -
...
//           CSwitchThumbPainter.radius +
//           currentThumbExtension,
//       trackRect.left + _kTrackInnerEnd + CSwitchThumbPainter.radius,
//       visualPosition,
//     )!;
//     final double thumbCenterY = offset.dy + size.height / 2.0;
//     final Rect thumbBounds = Rect.fromLTRB(
//       thumbLeft,
//       thumbCenterY - CSwitchThumbPainter.radius,
//       thumbRight,
//       thumbCenterY + CSwitchThumbPainter.radius,
//     );
...
//       _thumbPainter.paint(innerContext, thumbBounds);
...
//           child!,
//           Offset(
//             (thumbLeft + thumbRight) / 2 - (_kTrackHeight / 2),
//             thumbCenterY - _kTrackHeight / 2,
//           ));
//     }
//   }
...
// // class _CSwitchThumbRenderObject extends SingleChildRenderObjectWidget {
// //   _CSwitchThumbRenderObject({
// //     Key? key,
