...
extension CouverButtonStyleExtension on ButtonStyle {
  CButtonStyle get cButtonStyle => CButtonStyle(
        textStyle: textStyle,
...
///
/// Buttons and their themes have a CButtonStyle property which defines the visual
...
///
/// All of the CButtonStyle properties are null by default.
///
/// Many of the CButtonStyle properties are [MaterialStateProperty] objects which
...
/// ```
///
/// Configuring a CButtonStyle directly makes it possible to very
