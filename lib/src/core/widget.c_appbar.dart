...
class CAppBar extends StatefulWidget implements PreferredSizeWidget {
  ...
  ///
  /// The CAppBar is built within a `AnnotatedRegion<SystemUiOverlayStyle>`
  /// which causes [SystemChrome.setSystemUIOverlayStyle] to be called
  /// automatically.  Apps should not enclose the CAppBar with
  ...
  ///  * [ColorScheme.brightness], which indicates if the overall [Theme]
  ///    is light or dark.
  ///  * [backwardsCompatibility], which forces CAppBar to use this
  ///    obsolete property.
  @Deprecated(
    'This property is no longer used, please use systemOverlayStyle instead. '
    'This feature was deprecated after v2.4.0-0.0.pre.',
  ...
  /// Specifies the style to use for the system overlays that overlap the CAppBar.
  ///
...
class _CAppBarTitleBox extends SingleChildRenderObjectWidget {
  const _CAppBarTitleBox({Key? key, required Widget child})
