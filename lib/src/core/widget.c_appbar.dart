...
/// CAppBar is deprecated, use original [AppBar] instead
typedef CAppBar = AppBar;

/// CSliverAppBar is deprecated, use original [SliverAppBar] instead
typedef CSliverAppBar = SliverAppBar;
...
// import './widget.c_back_button.dart';
...
// class _PreferredCAppBarSize extends Size {
//   _PreferredCAppBarSize(this.toolbarHeight, this.bottomHeight)
//       : super.fromHeight(
...
// /// app bar, see [CSliverAppBar], which embeds an [CAppBar] in a sliver for use in
// /// a [CustomScrollView].
// ///
// /// The CAppBar displays the toolbar widgets, [leading], [title], and [actions],
...
// /// English):
// ///
// /// The [CAppBar] insets its content based on the ambient [MediaQuery]'s padding,
// /// to avoid system UI intrusions. It's taken care of by [Scaffold] when used in
// /// the [Scaffold.appBar] property. When animating an [CAppBar], unexpected
// /// [MediaQuery] changes (as is common in [Hero] animations) may cause the content
// /// to suddenly jump. Wrap the [CAppBar] in a [MediaQuery] widget, and adjust its
...
// ///
// /// If the [leading] widget is omitted, but the [CAppBar] is in a [Scaffold] with
...
// ///
// /// {@tool dartpad}
// /// This sample shows an [CAppBar] with two simple actions. The first action
...
// /// {@tool dartpad}
// /// This sample shows the creation of an [CAppBar] widget with the [shadowColor] and
...
// /// See also:
// ///
// ///  * [Scaffold], which displays the [CAppBar] in its [Scaffold.appBar] slot.
// ///  * [CSliverAppBar], which uses [CAppBar] to provide a flexible app bar that
// ///    can be used in a [CustomScrollView].
// ///  * [TabBar], which is typically placed in the [bottom] slot of the [CAppBar]
...
//         preferredSize =
//             _PreferredCAppBarSize(toolbarHeight, bottom?.preferredSize.height);

//   /// Used by [Scaffold] to compute its [CAppBar]'s overall height. The returned value is
//   /// the same `preferredSize.height` unless [CAppBar.toolbarHeight] was null and
...
//   /// the app bar's [CAppBar.bottom] widget.
//   static double preferredHeightFor(BuildContext context, Size preferredSize) {
//     if (preferredSize is _PreferredCAppBarSize &&
...
//   /// [CAppBar] will imply an appropriate widget. For example, if the [CAppBar] is
//   /// in a [Scaffold] that also has a [Drawer], the [Scaffold] will fill this
//   /// widget with an [IconButton] that opens the drawer (using [Icons.menu]). If
//   /// there's no [Drawer] and the parent [Navigator] can go back, the [CAppBar]
...
//   /// See also:
//   ///
//   ///  * [Scaffold.appBar], in which an [CAppBar] is usually placed.
...
//   ///
//   /// A flexible space isn't actually flexible unless the [CAppBar]'s container
//   /// changes the [CAppBar]'s size. A [CSliverAppBar] in a [CustomScrollView]
//   /// changes the [CAppBar]'s height when scrolled.
//   ///
...
//   /// null, then [CAppBar] uses the overall theme's [ColorScheme.primary] if the
...
//   /// value is also null, then [CAppBar] uses the overall theme's
...
//   /// used by [CSliverAppBar] to animate the opacity of the toolbar when the app
//   /// bar is scrolled.
//   /// {@endtemplate}
...
//   /// Defines the height of the toolbar component of an [CAppBar].
//   ///
...
//   /// The default text style for the CAppBar's [leading], and
...
//   /// The default text style for the CAppBar's [title] widget.
//   ///
...
//   /// See also:
//   ///
//   ///  * [toolbarTextStyle], which is the default text style for the CAppBar's
...
//         leading = useCloseButton ? const CCloseButton() : const CBackButton();
//       }
//     }
//     if (leading != null) {
...
//       title = _CAppBarTitleBox(child: title);
...
// class _CSliverAppBarDelegate extends SliverPersistentHeaderDelegate {
//   _CSliverAppBarDelegate(
...
//   @override
//   bool shouldRebuild(covariant _CSliverAppBarDelegate oldDelegate) {
...
// /// the screen see [CAppBar], which is used in the [Scaffold.appBar] slot.
// ///
// /// The CAppBar displays the toolbar widgets, [leading], [title], and
...
// ///
// /// {@tool dartpad}
// /// This sample shows a [CSliverAppBar] and it's behavior when using the
...
// /// See also:
// ///
// ///  * [CustomScrollView], which integrates the [CSliverAppBar] into its
// ///    scrolling.
// ///  * [CAppBar], which is a fixed-height app bar for use in [Scaffold.appBar].
// ///  * [TabBar], which is typically placed in the [bottom] slot of the [CAppBar]
// ///    if the screen has multiple pages arranged in tabs.
// ///  * [IconButton], which is used with [actions] to show buttons on the app bar.
// ///  * [PopupMenuButton], to show a popup menu on the app bar, via [actions].
...
// ///    can expand and collapse.
// ///  * <https://material.io/design/components/app-bars-top.html>
// class CSliverAppBar extends StatefulWidget {
...
//   ///
//   /// This property is used to configure an [CAppBar].
//   final Widget? leading;
...
//   /// content is not scrolled under the [CAppBar].
//   ///
//   /// Defaults to false, meaning that the [elevation] is only applied when the
//   /// [CAppBar] is being displayed over content that is scrolled under it.
//   ///
...
//   /// See also:
//   ///
//   ///  * [CSliverAppBar] for more animated examples of how this property changes the
...
//   @override
//   State<CSliverAppBar> createState() => _CSliverAppBarState();
// }

// // This class is only Stateful because it owns the TickerProvider used
// // by the floating appbar snap animation (via FloatingHeaderSnapConfiguration).
// class _CSliverAppBarState extends State<CSliverAppBar>
...
//   @override
//   void didUpdateWidget(CSliverAppBar oldWidget) {
...
//         delegate: _CSliverAppBarDelegate(
//           vsync: this,
...
// // Layout the CAppBar's title with unconstrained height, vertically
// // center it within its (NavigationToolbar) parent, and allow the
// // parent to constrain the title's actual height.
// class _CAppBarTitleBox extends SingleChildRenderObjectWidget {
//   const _CAppBarTitleBox({required Widget super.child});

//   @override
//   _RenderCAppBarTitleBox createRenderObject(BuildContext context) {
//     return _RenderCAppBarTitleBox(
...
//       BuildContext context, _RenderCAppBarTitleBox renderObject) {
//     renderObject.textDirection = Directionality.of(context);
//   }
// }

// class _RenderCAppBarTitleBox extends RenderAligningShiftedBox {
//   _RenderCAppBarTitleBox({
//     super.textDirection,
...
//           ? DefaultTextStyle(
//               style: config.collapsedTextStyle!.copyWith(
...
//           ? DefaultTextStyle(
//               style: config.expandedTextStyle!.copyWith(
//                   color: foregroundColor ?? appBarTheme.foregroundColor),
//               child: title!,
//             )
//           : title;
...
//       centerTitle =
//           centerCollapsedTitle ?? appBarTheme.centerTitle ?? platformCenter();
//     }
...
//       effectiveCollapsedTitlePadding =
//           EdgeInsetsDirectional.only(start: leadingWidth!);
//     }
